...
const templates = {
    hebrew: {
        greeting: 'שלום רב, תודה שפנית ל"אדמתנו ביתנו" – הבית הפיננסי של החברה העברית בישראל. 🏠',
        ...
        step_10: 'מעולה! שימו לב גם אם אמרו לכם *לא* אל תמהרו לוותר. אפשר לדבר, להבין את המצב, ולראות אם יש דרך לסייע לכם. בשקט, בכבוד ובלי הבטחות באוויר. הפרטים שלך הועברו למומחים לבחינה ראשונית. מתי נוח לך שנציג יחזור לשיחת ייעוץ ללא עלות?',
