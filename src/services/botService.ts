...
const templates = {
    hebrew: {
        ...
        step_9: 'כדי שנוכל להכין את התיק בצורה הטובה ביותר מול הבנקים, האם היו בעיות בחשבון ב-3 השנים האחרונות? (כגון חזרות צ\'קים, הגבלות או עיקולים)? (כן / לא)',
        step_10: 'מעולה! שימו לב גם אם אמרו לכם *לא* אל תמהרו לוותר. אפשר לדבר, להבין את המצב, ולראות אם יש דרך לסייע לכם. בשקט, בכבוד ובלי הבטחות באוויר.\n\nהפרטים שלך הועברו לבחינה ראשונית. מתי נוח לך שנציג יחזור לשיחת ייעוץ ללא עלות?',
