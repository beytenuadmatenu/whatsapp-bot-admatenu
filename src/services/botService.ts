...
const templates = {
    hebrew: {
        ...
        step_10_a: 'מעולה! שימו לב גם אם אמרו לכם *לא* אל תמהרו לוותר. אפשר לדבר, להבין את המצב, ולראות אם יש דרך לסייע לכם. בשקט, בכבוד ובלי הבטחות באוויר.',
    ...
    arabic: {
        ...
        step_3_below_min_final: 'بما أننا متخصصون في القروض بمبالغ أعلى، للأسف لا يوجد لدينا مسار مناسب לطلبك حالياً. سنكون سعداء بخدمتك في المستقبل إذا تغيرت الاحتياجات. بالتوفيق!',
        ...
        step_10_a: 'تم تحويل بياناتك إلى خبرائنا للفحص الأولي.',
        step_10_b: 'ما هو الوقت الأنسب لك ليتصل بك مندوبنا للاستشارة؟',
